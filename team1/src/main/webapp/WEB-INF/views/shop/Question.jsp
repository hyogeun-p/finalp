    ...
    <main>
        ...
        <form method="post">
            ...
            <div class="question_Type">
                <h3>문의유형</h3>
                <select name="q_category" id="question_Type_Select" required>
            ...
            <div class="question_Open">
                ...
                <label for="question_Open_Radio1"><input type="radio" id="question_Open_Radio1" name="qna_public" value="qna_public">공개</label>
                <label for="question_Open_Radio2"><input type="radio" id="question_Open_Radio2" name="qna_public" value="qna_public">비공개</label>
                </div>
            </div>
